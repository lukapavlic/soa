 ...
 * 
 */
@WebServiceClient(name = "KalkulatorService", targetNamespace = "http://feri.um.si/", wsdlLocation = "http://localhost:8080/03_SpletnStoritev/Kalkulator?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/03_SpletnStoritev/Kalkulator?wsdl");
