 ...
 * 
 */
@WebServiceClient(name = "KalkulatorService", targetNamespace = "http://feri.um.si/", wsdlLocation = "file:/E:/GIT/github_soa/04_SpletnaStoritev_WF_ContractFirst/src/KalkulatorService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/E:/GIT/github_soa/04_SpletnaStoritev_WF_ContractFirst/src/KalkulatorService.wsdl");
