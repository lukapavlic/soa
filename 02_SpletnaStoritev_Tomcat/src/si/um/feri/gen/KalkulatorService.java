 ...
 * 
 */
@WebServiceClient(name = "KalkulatorService", targetNamespace = "http://feri.um.si/", wsdlLocation = "http://localhost:8080/02_SpletnaStoritev/kalk?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/02_SpletnaStoritev/kalk?wsdl");
