 ...
 * generated in the si.um.feri.gen.server package. 
...
public class ObjectFactory {
    ...
    private final static QName _OdjaviOdObvestil_QNAME = new QName("http://feri.um.si/", "odjaviOdObvestil");
    ...
    private final static QName _NarociNaObvestila_QNAME = new QName("http://feri.um.si/", "narociNaObvestila");
    private final static QName _OdjaviOdObvestilResponse_QNAME = new QName("http://feri.um.si/", "odjaviOdObvestilResponse");
    ...
    private final static QName _NarociNaObvestilaResponse_QNAME = new QName("http://feri.um.si/", "narociNaObvestilaResponse");
    private final static QName _MnoziResponse_QNAME = new QName("http://feri.um.si/", "mnoziResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: si.um.feri.gen.server
     * 
     */
    ...
    /**
     * Create an instance of {@link OdjaviOdObvestilResponse }
     * 
     */
    public OdjaviOdObvestilResponse createOdjaviOdObvestilResponse() {
        return new OdjaviOdObvestilResponse();
    }
    ...
    /**
     * Create an instance of {@link NarociNaObvestilaResponse }
     * 
     */
    public NarociNaObvestilaResponse createNarociNaObvestilaResponse() {
        return new NarociNaObvestilaResponse();
    }
    ...
    /**
     * Create an instance of {@link OdjaviOdObvestil }
     * 
     */
    public OdjaviOdObvestil createOdjaviOdObvestil() {
        return new OdjaviOdObvestil();
    }

    /**
     * Create an instance of {@link NarociNaObvestila }
     * 
     */
    public NarociNaObvestila createNarociNaObvestila() {
        return new NarociNaObvestila();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link OdjaviOdObvestil }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://feri.um.si/", name = "odjaviOdObvestil")
    public JAXBElement<OdjaviOdObvestil> createOdjaviOdObvestil(OdjaviOdObvestil value) {
        return new JAXBElement<OdjaviOdObvestil>(_OdjaviOdObvestil_QNAME, OdjaviOdObvestil.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link NarociNaObvestila }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://feri.um.si/", name = "narociNaObvestila")
    public JAXBElement<NarociNaObvestila> createNarociNaObvestila(NarociNaObvestila value) {
        return new JAXBElement<NarociNaObvestila>(_NarociNaObvestila_QNAME, NarociNaObvestila.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link OdjaviOdObvestilResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://feri.um.si/", name = "odjaviOdObvestilResponse")
    public JAXBElement<OdjaviOdObvestilResponse> createOdjaviOdObvestilResponse(OdjaviOdObvestilResponse value) {
        return new JAXBElement<OdjaviOdObvestilResponse>(_OdjaviOdObvestilResponse_QNAME, OdjaviOdObvestilResponse.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link NarociNaObvestilaResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://feri.um.si/", name = "narociNaObvestilaResponse")
    public JAXBElement<NarociNaObvestilaResponse> createNarociNaObvestilaResponse(NarociNaObvestilaResponse value) {
        return new JAXBElement<NarociNaObvestilaResponse>(_NarociNaObvestilaResponse_QNAME, NarociNaObvestilaResponse.class, null, value);
    }
