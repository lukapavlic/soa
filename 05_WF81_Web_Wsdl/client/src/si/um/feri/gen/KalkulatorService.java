 ...
 * 
 */
@WebServiceClient(name = "KalkulatorService", targetNamespace = "http://ws.feri.um.si/", wsdlLocation = "http://localhost:8080/05_WildFly81_Web_WsdlWeb/Kalkulator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName KALKULATORSERVICE_QNAME = new QName("http://ws.feri.um.si/", "KalkulatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/05_WildFly81_Web_WsdlWeb/Kalkulator?wsdl");
    ...
    public Kalkulator getKalkulatorPort() {
        return super.getPort(new QName("http://ws.feri.um.si/", "KalkulatorPort"), Kalkulator.class);
    }
    ...
    public Kalkulator getKalkulatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.feri.um.si/", "KalkulatorPort"), Kalkulator.class, features);
    }
