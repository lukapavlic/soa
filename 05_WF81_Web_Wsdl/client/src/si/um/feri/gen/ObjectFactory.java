...
public class ObjectFactory {
    ...
    private final static QName _Odstej_QNAME = new QName("http://ws.feri.um.si/", "odstej");
    private final static QName _MnoziResponse_QNAME = new QName("http://ws.feri.um.si/", "mnoziResponse");
    private final static QName _DeliResponse_QNAME = new QName("http://ws.feri.um.si/", "deliResponse");
    private final static QName _Mnozi_QNAME = new QName("http://ws.feri.um.si/", "mnozi");
    private final static QName _OdstejResponse_QNAME = new QName("http://ws.feri.um.si/", "odstejResponse");
    private final static QName _SestejResponse_QNAME = new QName("http://ws.feri.um.si/", "sestejResponse");
    private final static QName _Deli_QNAME = new QName("http://ws.feri.um.si/", "deli");
    private final static QName _ObdelajResponse_QNAME = new QName("http://ws.feri.um.si/", "obdelajResponse");
    private final static QName _Sestej_QNAME = new QName("http://ws.feri.um.si/", "sestej");
    private final static QName _Obdelaj_QNAME = new QName("http://ws.feri.um.si/", "obdelaj");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.feri.um.si/", name = "odstej")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.feri.um.si/", name = "mnoziResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.feri.um.si/", name = "deliResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.feri.um.si/", name = "mnozi")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.feri.um.si/", name = "odstejResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.feri.um.si/", name = "sestejResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.feri.um.si/", name = "deli")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.feri.um.si/", name = "obdelajResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.feri.um.si/", name = "sestej")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.feri.um.si/", name = "obdelaj")
